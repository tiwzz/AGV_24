...
//舵电机的编码值零点
#define Forward_L_ecd 2758    //左前轮  1号
#define Forward_R_ecd 6166    //右前轮  2号
#define Back_L_ecd 685       //左后轮  3号
#define Back_R_ecd 1350       //右后轮  4号
...
#define CHASSIS_FOLLOW_GIMBAL_PID_KD  25.0f//20.f//10.0f 
