...
// 底盘低通滤波系数
#define CHASSIS_ACCEL_X_NUM 0.025f
#define CHASSIS_ACCEL_Y_NUM 0.015f

// 斜坡函数系数
#define CHASSIS_RAMP_X_NUM 0.01f
#define CHASSIS_RAMP_Y_NUM 0.01f
#define MAX_RAMP_X_OUT 10
#define MAX_RAMP_Y_OUT 10
#define MIN_RAMP_X_OUT -10
#define MIN_RAMP_Y_OUT -10
...
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 6.0f // 3.0f               // 3.0f
